...
(deftest server-xml-test
  (defnode test-node [:ubuntu])
  (is (= "<?xml version='1.0' encoding='utf-8'?>\n<Server shutdown=\"SHUTDOWNx\" port=\"123\">\n  <Listener></Listener>\n  <GlobalNamingResources>\n    <Environment></Environment>\n    <Resource></Resource>\n    <Transaction></Transaction>\n  </GlobalNamingResources>\n  <Service name=\"Catalina\">\n    <Connector redirectPort=\"8443\" connectionTimeout=\"20000\" protocol=\"HTTP/1.1\" port=\"8080\"></Connector>\n    <Engine defaultHost=\"localhost\" name=\"Catalina\">\n      <Cluster className=\"org.apache.catalina.ha.tcp.SimpleTcpCluster\"></Cluster>\n      <Valve className=\"org.apache.catalina.valves.RequestDumperValve\"></Valve>\n      <Realm resourceName=\"UserDatabase\" className=\"org.apache.catalina.realm.UserDatabaseRealm\"></Realm>\n\n      <Host xmlNamespaceAware=\"false\" xmlValidation=\"false\" autoDeploy=\"true\" unpackWARs=\"true\" appBase=\"webapps\" name=\"localhost\">\n\n\t<Valve className=\"org.apache.catalina.authenticator.SingleSignOn\"></Valve>\n\t<Valve resolveHosts=\"false\" pattern=\"common\" suffix=\".txt\" prefix=\"localhost_access_log.\" directory=\"logs\" className=\"org.apache.catalina.valves.AccessLogValve\"></Valve>\n      </Host>\n    </Engine>\n  </Service>\n</Server>"
  ...
  (is (= "<?xml version='1.0' encoding='utf-8'?>\n<Server shutdown=\"SHUTDOWNx\" port=\"123\">\n  <Listener className=\"org.apache\"></Listener><Listener className=\"org.apache.catalina.core.JasperListener\"></Listener>\n  <GlobalNamingResources>\n    \n    \n    \n  </GlobalNamingResources>\n  <Service name=\"Catalina\">\n    <Connector redirectPort=\"8443\" connectionTimeout=\"20000\" protocol=\"HTTP/1.1\" port=\"8080\"></Connector>\n    <Engine defaultHost=\"localhost\" name=\"Catalina\">\n      <Cluster className=\"org.apache.catalina.ha.tcp.SimpleTcpCluster\"></Cluster>\n      <Valve className=\"org.apache.catalina.valves.RequestDumperValve\"></Valve>\n      <Realm resourceName=\"UserDatabase\" className=\"org.apache.catalina.realm.UserDatabaseRealm\"></Realm>\n\n      <Host xmlNamespaceAware=\"false\" xmlValidation=\"false\" autoDeploy=\"true\" unpackWARs=\"true\" appBase=\"webapps\" name=\"localhost\">\n\n\t<Valve className=\"org.apache.catalina.authenticator.SingleSignOn\"></Valve>\n\t<Valve resolveHosts=\"false\" pattern=\"common\" suffix=\".txt\" prefix=\"localhost_access_log.\" directory=\"logs\" className=\"org.apache.catalina.valves.AccessLogValve\"></Valve>\n      </Host>\n    </Engine>\n  </Service>\n</Server>"
         (apply str
                (tomcat-server-xml
                 test-node
                 (server
  ...
  (is (= "<?xml version='1.0' encoding='utf-8'?>\n<Server shutdown=\"SHUTDOWNx\" port=\"123\">\n  <Listener></Listener>\n  <GlobalNamingResources>\n    <Environment name=\"name\" type=\"java.lang.Integer\" value=\"1\"></Environment>\n    <Resource name=\"jdbc/mydb\" type=\"javax.sql.DataSource\" description=\"my db\"></Resource>\n    <Transaction factory=\"some.transaction.class\"></Transaction>\n  </GlobalNamingResources>\n  <Service name=\"Catalina\">\n    <Connector redirectPort=\"8443\" connectionTimeout=\"20000\" protocol=\"HTTP/1.1\" port=\"8080\"></Connector>\n    <Engine defaultHost=\"localhost\" name=\"Catalina\">\n      <Cluster className=\"org.apache.catalina.ha.tcp.SimpleTcpCluster\"></Cluster>\n      <Valve className=\"org.apache.catalina.valves.RequestDumperValve\"></Valve>\n      <Realm resourceName=\"UserDatabase\" className=\"org.apache.catalina.realm.UserDatabaseRealm\"></Realm>\n\n      <Host xmlNamespaceAware=\"false\" xmlValidation=\"false\" autoDeploy=\"true\" unpackWARs=\"true\" appBase=\"webapps\" name=\"localhost\">\n\n\t<Valve className=\"org.apache.catalina.authenticator.SingleSignOn\"></Valve>\n\t<Valve resolveHosts=\"false\" pattern=\"common\" suffix=\".txt\" prefix=\"localhost_access_log.\" directory=\"logs\" className=\"org.apache.catalina.valves.AccessLogValve\"></Valve>\n      </Host>\n    </Engine>\n  </Service>\n</Server>"
         (apply str
                (tomcat-server-xml
                 test-node
                 (server
...
(deftest server-configuration-test
  (defnode a [])
  (with-target-tag :a
    (is (= "cat > /var/lib/tomcat6/server.xml <<EOF\n<?xml version='1.0' encoding='utf-8'?>\n<Server shutdown=\"SHUTDOWNx\" port=\"123\">\n  <Listener></Listener>\n  <GlobalNamingResources>\n    \n    \n    \n  </GlobalNamingResources>\n  <Service name=\"Catalina\">\n    <Connector redirectPort=\"8443\" connectionTimeout=\"20000\" protocol=\"HTTP/1.1\" port=\"8080\"></Connector>\n    <Engine defaultHost=\"localhost\" name=\"Catalina\">\n      <Cluster className=\"org.apache.catalina.ha.tcp.SimpleTcpCluster\"></Cluster>\n      <Valve className=\"org.apache.catalina.valves.RequestDumperValve\"></Valve>\n      <Realm resourceName=\"UserDatabase\" className=\"org.apache.catalina.realm.UserDatabaseRealm\"></Realm>\n\n      <Host xmlNamespaceAware=\"false\" xmlValidation=\"false\" autoDeploy=\"true\" unpackWARs=\"true\" appBase=\"webapps\" name=\"localhost\">\n\n\t<Valve className=\"org.apache.catalina.authenticator.SingleSignOn\"></Valve>\n\t<Valve resolveHosts=\"false\" pattern=\"common\" suffix=\".txt\" prefix=\"localhost_access_log.\" directory=\"logs\" className=\"org.apache.catalina.valves.AccessLogValve\"></Valve>\n      </Host>\n    </Engine>\n  </Service>\n</Server>\nEOF\n"
           (build-resources []
