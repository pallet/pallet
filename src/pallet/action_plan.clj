...
(defn action-map
  ...
  [action arg-vector precedence-map]
  (let [precedence-map (and precedence-map (seq precedence-map)
                            (update-in precedence-map [:action-id]
                                       #(or % (gensym "action-id"))))]

    (merge
     (merge (action-precedence action) precedence-map)
     {:action action
      :args arg-vector
