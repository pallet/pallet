...
- Use image selected by template for creating new images instead of using the
  template it's self
  This had the effect of causing the bridged-network parameter (amongst
  others) to be dropped from the image specification making it impossable
